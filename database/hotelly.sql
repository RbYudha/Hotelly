...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Jul 2020 pada 13.01
...
(112, 1004, 111, 20, '2020-01-03'),
(114, 1004, 111, 10, '2020-02-02'),
(115, 1004, 112, 19, '2020-01-01'),
(116, 1004, 113, 20, '2020-01-01'),
(117, 1004, 211, 100, '2020-01-01'),
(118, 1004, 212, 5, '2020-01-01'),
(119, 1004, 213, 5, '2020-02-01'),
(120, 1004, 111, 10, '2020-03-01'),
(121, 1004, 311, 40, '2020-01-01'),
(122, 1004, 312, 15, '2020-01-01'),
(123, 1004, 411, 25, '2020-01-01'),
(124, 1004, 412, 9, '2020-01-01'),
(125, 1004, 511, 31, '2020-01-01'),
(127, 1004, 213, 12, '2020-01-01'),
(128, 1004, 214, 21, '2020-01-01'),
(129, 1004, 112, 44, '2020-02-15'),
(130, 1004, 111, 50, '2020-04-05');
...
(234, 1004, 111, 400, 5000, 2000000, '2020-04-04'),
...
--
ALTER TABLE `ambilbarang`
  MODIFY `id_ambil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
...
--
ALTER TABLE `stokingbarang`
  MODIFY `id_stoking` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=243;
