            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#tambahkategori_kamar">Tambah Data</button>
                        <h1 class="h3 mb-4 text-gray-800">List kategori kamar</h1>
                        <hr>
                        <table class="table table-striped" align="center" id="datakategori_kamar">
                            <thead align="center">
                                <tr>
                                    <th>ID kategori</th>
                                    <th>Nama Kategori kamar</th>
                                    <th>Opsi</th>
                                </tr>
                            </thead>
                            <tbody align="center">
