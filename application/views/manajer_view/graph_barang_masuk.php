...
foreach ($dataProdukChart as $k => $v) {
    $arrProd1[] = ['label' => $v->date_stoking,  'y' => $v->stok_barang];
}
...
$dataProdukChart = $this->db->get("stokingbarang")->result();
foreach ($dataProdukChart as $k => $v) {
    $arrProd2[] = ['label' => $v->date_stoking,  'y' => $v->stok_barang];
}
...
$dataProdukChart = $this->db->get("stokingbarang")->result();
foreach ($dataProdukChart as $k => $v) {
    $arrProd3[] = ['label' => $v->date_stoking,  'y' => $v->stok_barang];
}
...
$dataProdukChart = $this->db->get("stokingbarang")->result();
foreach ($dataProdukChart as $k => $v) {
    $arrProd4[] = ['label' => $v->date_stoking,  'y' => $v->stok_barang];
}
...
$dataProdukChart = $this->db->get("stokingbarang")->result();
foreach ($dataProdukChart as $k => $v) {
    $arrProd5[] = ['label' => $v->date_stoking,  'y' => $v->stok_barang];
}
...
$dataProdukChart = $this->db->get("stokingbarang")->result();
foreach ($dataProdukChart as $k => $v) {
    $arrProd6[] = ['label' => $v->date_stoking,  'y' => $v->stok_barang];
}
...
$dataProdukChart = $this->db->get("stokingbarang")->result();
foreach ($dataProdukChart as $k => $v) {
    $arrProd7[] = ['label' => $v->date_stoking,  'y' => $v->stok_barang];
}
...
$dataProdukChart = $this->db->get("stokingbarang")->result();
foreach ($dataProdukChart as $k => $v) {
    $arrProd8[] = ['label' => $v->date_stoking,  'y' => $v->stok_barang];
}
...
$dataProdukChart = $this->db->get("stokingbarang")->result();
foreach ($dataProdukChart as $k => $v) {
    $arrProd9[] = ['label' => $v->date_stoking,  'y' => $v->stok_barang];
}
...
$dataProdukChart = $this->db->get("stokingbarang")->result();
foreach ($dataProdukChart as $k => $v) {
    $arrProd10[] = ['label' => $v->date_stoking,  'y' => $v->stok_barang];
}
...
$dataProdukChart = $this->db->get("stokingbarang")->result();
foreach ($dataProdukChart as $k => $v) {
    $arrProd11[] = ['label' => $v->date_stoking,  'y' => $v->stok_barang];
}
...
$dataProdukChart = $this->db->get("stokingbarang")->result();
foreach ($dataProdukChart as $k => $v) {
    $arrProd12[] = ['label' => $v->date_stoking,  'y' => $v->stok_barang];
}
            ...
            <script>
                window.onload = function() {
                    ...
                    var chart = new CanvasJS.Chart("chartContainer", {
                        ...
                        title: {
                            text: "Data barang yang masuk ke storage"
                        },
                        axisY: {
                            includeZero: false,
